...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Blog & Catatan Artikel Pribadi | HitungSaham.com',
    description: 'Artikel personal, catatan opini pribadi pengelola, dan kalkulator simulasi matematis saham.',
    url: 'https://hitungsaham.com/landing-2/blog',
  ...
  alternates: {
    canonical: 'https://hitungsaham.com/landing-2/blog',
  },
};
...
export default async function PersonalBlogPage() {
  ...
  const jsonLd = {
    ...
    blogPost: articles.map((art: ArticleData) => ({
      ...
      url: `https://hitungsaham.com/landing-2/blog/${art.slug}`,
  ...
  return (
    <div className={styles.page}>
      ...
      <main className={styles.container}>
        {articles.length === 0 ? (
          /* EMPTY STATE FOR LANDING 2 BLOG */
          <div className="flex flex-col items-center justify-center py-20 px-4 text-center bg-[#f2f2ef] rounded-3xl border border-dashed border-[#111210]/15 space-y-4 my-8">
            <div className="w-16 h-16 rounded-full bg-[#111210] text-white flex items-center justify-center text-2xl font-bold shadow-md">
              <BookOpen size={28} />
            </div>
          ...
          <>
            ...
            <section className={styles.heroGrid}>
              ...
              {mainHeadline && (
                <Link href={`/landing-2/blog/${mainHeadline.slug}`} className={styles.mainPostCard}>
              ...
              <div className={styles.secondaryColumn}>
                {secondaryPosts.map((post: ArticleData) => (
                  <Link key={post.id} href={`/landing-2/blog/${post.slug}`} className={styles.secondaryCard}>
