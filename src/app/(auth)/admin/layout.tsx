    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-page text-main">
        <div className="flex items-center gap-2.5 text-sm font-semibold text-muted">
          <RefreshCw size={18} className="animate-spin text-acc-blue" /> Memuat
          CMS...
        </div>
      </div>
    );
    ...
    <>
      <div className="flex h-16 shrink-0 items-center gap-3 border-b border-border-custom px-5">
        ...
        <div className="min-w-0">
          <p className="truncate text-sm font-bold tracking-tight text-main">
            HitungSaham
          </p>
        ...
        {mobileSidebarOpen && (
          <div className="fixed inset-0 z-50 flex md:hidden">
            ...
            <aside className="relative flex h-full w-[min(84vw,280px)] flex-col border-r border-border-custom bg-card">
              ...
              <button
                onClick={() => setMobileSidebarOpen(false)}
                className="absolute right-3 top-3 flex h-9 w-9 items-center justify-center rounded-lg text-muted hover:bg-sub-slate hover:text-main"
          ...
          <header className="flex h-16 shrink-0 items-center justify-between border-b border-border-custom bg-card px-4 sm:px-6">
            <div className="flex min-w-0 items-center gap-3">
              <button
                ...
                className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg text-muted hover:bg-sub-slate hover:text-main md:hidden"
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="relative">
                ...
                >
                  <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-acc-blue text-xs font-bold text-white">
                    A
                  </span>
                ...
                {profileOpen && (
                  <>
                    ...
                    <div className="absolute right-0 z-30 mt-2 w-64 rounded-2xl border border-border-custom bg-card p-2">
                      <div className="border-b border-border-custom px-3 py-3">
                      ...
                      <button
                        ...
                        className="mt-2 flex w-full items-center gap-2.5 rounded-xl px-3 py-2.5 text-sm font-semibold text-rose-600 hover:bg-rose-500/10"
                      >
                        <LogOut size={16} /> Keluar dari CMS
                      </button>
                    </div>
                  </>
                )}
