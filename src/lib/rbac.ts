...
export const CMS_FEATURES: FeatureDefinition[] = [
  {
    id: 'overview',
    label: 'Dashboard',
    description: 'Melihat ringkasan statistik kunjungan, aksi kalkulator, dan konten.',
    category: 'Overview',
    path: '/admin',
  },
  {
    id: 'articles',
    label: 'Artikel & Blog',
    description: 'Membuat, mengedit, mempublikasikan, dan menghapus artikel & blog.',
    category: 'Konten',
    path: '/admin/articles',
  },
  {
  ...
  },
  {
    id: 'faqs',
    label: 'FAQ',
    description: 'Mengelola daftar pertanyaan dan jawaban seputar kalkulator saham.',
    category: 'Konten',
    path: '/admin/faqs',
  },
  {
    ...
    description: 'Mengonfigurasi rentang harga fraksi dan tick penawaran saham BEI.',
  ...
  },
  {
    ...
    description: 'Mengatur persentase Auto Rejection Atas dan Bawah per papan bursa.',
    category: 'Konfigurasi',
    path: '/admin/ara-arb',
  },
  {
  ...
  },
  {
    ...
    description: 'Mengelola data pengguna, peran dinamis (roles), dan hak akses per-fitur.',
    category: 'Konfigurasi',
    path: '/admin/users',
  },
];
...
export const DEFAULT_DYNAMIC_ROLES: DynamicRole[] = [
  ...
  },
  {
    ...
    description: 'Membuat dan mengelola artikel, blog, kategori konten, dan FAQ.',
    isProtected: false,
  ...
  },
  {
    ...
    description: 'Pengguna publik yang mendaftar via Google OAuth untuk riwayat perhitungan.',
    isProtected: true,
    permissions: [],
  },
];
